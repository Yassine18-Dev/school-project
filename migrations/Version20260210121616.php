 ...
 */
final class Version20260210121616 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE team ADD bio LONGTEXT DEFAULT NULL, DROP created_at');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE team ADD created_at DATETIME NOT NULL, DROP bio');
